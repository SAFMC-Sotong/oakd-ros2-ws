...
void readParameters(std::string config_file)
{
    ...
    DISPLAY_STAT = fsSettings["display_statistics"];
    PUB_ODOM = fsSettings["publish_odom"];
    PUB_PC = fsSettings["publish_pointcloud"];
    PUB_KEYFRAME = fsSettings["publish_keyframe_pose"];
    PUB_CAMERA_POSE = fsSettings["publish_camera_pose"];

    fsSettings["odom_frame_id"] >> ODOM_FRAME_ID;
    fsSettings["odom_child_frame_id"] >> ODOM_CHILD_FRAME_ID;
    ...
    std::cout << "body_frame_id: " << BODY_FRAME_ID << std::endl;
